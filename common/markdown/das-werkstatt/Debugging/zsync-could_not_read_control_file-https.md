# Fix: zsync error ‘could not read control file from URL’

So I wanted to use [zsync](http://zsync.moria.org.uk/) to download/update my [existing ISO file of MX-Linux](https://mxlinux.org/wiki/system/zsync/) from v23.6 to v25:
